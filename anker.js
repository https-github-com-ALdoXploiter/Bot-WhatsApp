...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:ALdo_BoT\n'
            + 'ORG:Owner Gans;\n'
            + 'TEL;type=CELL;type=VOICE;waid=6288230590974:+62 882-3059-0974\n'
            + 'END:VCARD'

prefix = "#"
name = "AldoRaffy_Xploiter"
...
memberLimit = 2
ban = [""]
premium = ["6288230590974@s.whatsapp.net"]
...
async function starts() {
	...
	dms.on('chat-update', async (mek) => {
		try {
			...
			const BotWea2 = ["088230590974@s.whatsapp.net"] // ubah aja gapapa
			...
			mess = {
				...
				only: {
					...
					userB: `*Hallo Kak* ${pushname2} *Kayanya Kamu Blm Terdaftar Sebagai Teman ALdo_BoT*\n*Ketik ${prefix}daftar nama|umur*\n*Contoh ${prefix}daftar ./ALdoGaNz|17*`,
			...
			const ownerNumber = ["6288230590974@s.whatsapp.net"] // owner number ubah aja
		...
		case prefix+'daftar':
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				case prefix+'info':
					...
					user.push(sender)
					uptime = process.uptime()
					teks = `➽ *Nama Bot* : ALdo_BoT\n➽ *Owner Bot* : wa.me/6288230590974\n➽ *prefix* : | ${prefix} |\n➽ *Total Block* : ${blocked.length}\n➽ *Aktif Sejak* : ${kyun(uptime)}\n\n➽ *Total Pengguna* : ${user.length} User\n➽ *Instagram* : https://www.instagram.com/aldosaha_666\n➽ *Special Thanks To* :\n\n➽ Allah SWT \n➽ MhankBarBar\n➽ Nurutomo\n➽ Monurios\n➽Fxc7\n➽https://github.com/Fxc7/termux-bot-wa`
